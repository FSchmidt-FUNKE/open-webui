...
app.state.config.BING_SEARCH_API_KEY = BING_SEARCH_API_KEY
    ...
    return {
        ...
        "web": {
            ...
            "search": {
                ...
                "bing_search_api_key": app.state.config.BING_SEARCH_API_KEY,
...
async def update_rag_config(form_data: ConfigUpdateForm, user=Depends(get_admin_user)):
    ...
    if form_data.web is not None:
        ...
        app.state.config.BING_SEARCH_API_KEY = (
            form_data.web.search.bing_search_api_key
        )
...
def search_web(engine: str, query: str) -> list[SearchResult]:
    ...
    if engine == "searxng":
        ...
        if app.state.config.BING_SEARCH_API_KEY:
            return search_bing(
                app.state.config.BING_SEARCH_API_KEY,
                query,
                app.state.config.RAG_WEB_SEARCH_RESULT_COUNT,
            ...
            raise Exception("No BING_SEARCH_API_KEY found in environment variables")
